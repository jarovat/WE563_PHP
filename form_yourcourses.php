...
<div class="container col-12">
    <div class="">
        ...
        <div class="container-fluid ">
            <div class="center d-sm-flex flex-sm-column flex-md-row justify-content-between align-items-center mt-5">
                <h3>คอร์สที่คุณสร้าง</h3>
                <a href="form_addcourses.php" class='btn btn-success '>สร้างคอร์สของคุณเอง</a>
            ...
            <div class="container-fluid col-12 mt-5">
                <div class="row g-4">
                        ...
                        echo                     "</div>";
                        echo                     "<div class='col-auto'>";
                        echo                         "<a>3.0 (10 รีวิว)</a>";
                        echo                     "</div>";
                        echo                "<p class='card-text mt-2'>".iconv_substr($row["c_detail"],0,300,'UTF-8')."</p>";                
                        echo                "</div>";
                        echo             "</div>";
                        echo             "<a href='form_addcourses.php?coursesID=".$row['c_id']."' class='btn btn-secondary '>แก้ไขคอร์ส</a>";
                        echo         "</div>";
                        echo     "</div> ";
                        }
                    } else {
                        echo "<h5>คุณไม่ได้สร้าง คอร์สไว้</h5>";
                    }
                    $conn->close();
                    ?>
                </div>
